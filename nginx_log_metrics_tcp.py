...
name_total_requests_p ='nginx_' + s +'_nginx_log_metrics_tcp_total_requests'
name_upstream_requests_p ='nginx_'+ s + '_nginx_log_metrics_tcp_upstream_requests' 
name_total_bytes_p ='nginx_'+ s + '_nginx_log_metrics_total_tcp_bytes'
